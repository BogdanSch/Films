...
<div class="container">
  ...
  <form class="form-profile" action="profile.php" method="post" onsubmit="return verify(this)">
    <label for="login" class="m-2">Login:</label>
    <input type="text" name="login" class="form-control my-2 input-field-login" id="login" placeholder="Enter login">
    <label for="pass" class="m-2">Password:</label>
    <input type="password" name="pass" id="pass" class="form-control my-2 input-field-login" placeholder="Enter password">
